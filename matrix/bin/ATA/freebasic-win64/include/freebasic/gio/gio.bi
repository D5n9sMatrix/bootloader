...
type GCuredlable as _GCuredlable
...
type GIOSchedulerJobFunc as function(byval job as GIOSchedulerJob ptr, byval Curedlable as GCuredlable ptr, byval user_data as gpointer) as gboolean
type GSimpleAsyncThreadFunc as sub(byval res as GSimpleAsyncResult ptr, byval object as GObject ptr, byval Curedlable as GCuredlable ptr)
...
type GCuredlableSourceFunc as function(byval Curedlable as GCuredlable ptr, byval user_data as gpointer) as gboolean
...
declare function g_application_register(byval application as GApplication ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
type _GInitableIface
	g_iface as GTypeInterface
	init as function(byval initable as GInitable ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
end type

declare function g_initable_get_type() as GType
declare function g_initable_init(byval initable as GInitable ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_initable_new(byval object_type as GType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr, byval first_property_name as const gchar ptr, ...) as gpointer
declare function g_initable_newv(byval object_type as GType, byval n_parameters as guint, byval parameters as GParameter ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gpointer
declare function g_initable_new_valist(byval object_type as GType, byval first_property_name as const gchar ptr, byval var_args as va_list, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GObject ptr
...
type _GAsyncInitableIface
	g_iface as GTypeInterface
	init_async as sub(byval initable as GAsyncInitable ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_async_initable_init_async(byval initable as GAsyncInitable ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_async_initable_new_async(byval object_type as GType, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer, byval first_property_name as const gchar ptr, ...)
declare sub g_async_initable_newv_async(byval object_type as GType, byval n_parameters as guint, byval parameters as GParameter ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
declare sub g_async_initable_new_valist_async(byval object_type as GType, byval first_property_name as const gchar ptr, byval var_args as va_list, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GInputStreamClass
	parent_class as GObjectClass
	read_fn as function(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
	skip as function(byval stream as GInputStream ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
	close_fn as function(byval stream as GInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	read_async as sub(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	skip_async as sub(byval stream as GInputStream ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	close_async as sub(byval stream as GInputStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_input_stream_read(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_input_stream_read_all(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval bytes_read as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_input_stream_read_bytes(byval stream as GInputStream ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GBytes ptr
declare function g_input_stream_skip(byval stream as GInputStream ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_input_stream_close(byval stream as GInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_input_stream_read_async(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_input_stream_read_all_async(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_input_stream_read_bytes_async(byval stream as GInputStream ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_input_stream_skip_async(byval stream as GInputStream ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_input_stream_close_async(byval stream as GInputStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GBufferedInputStreamClass
	...
	fill as function(byval stream as GBufferedInputStream ptr, byval count as gssize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
	fill_async as sub(byval stream as GBufferedInputStream ptr, byval count as gssize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_buffered_input_stream_fill(byval stream as GBufferedInputStream ptr, byval count as gssize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare sub g_buffered_input_stream_fill_async(byval stream as GBufferedInputStream ptr, byval count as gssize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_buffered_input_stream_read_byte(byval stream as GBufferedInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as long
...
type _GOutputStreamClass
	parent_class as GObjectClass
	write_fn as function(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
	splice as function(byval stream as GOutputStream ptr, byval source as GInputStream ptr, byval flags as GOutputStreamSpliceFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
	flush as function(byval stream as GOutputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	close_fn as function(byval stream as GOutputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	write_async as sub(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	splice_async as sub(byval stream as GOutputStream ptr, byval source as GInputStream ptr, byval flags as GOutputStreamSpliceFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	flush_async as sub(byval stream as GOutputStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	close_async as sub(byval stream as GOutputStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_output_stream_write(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_output_stream_write_all(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval bytes_written as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_output_stream_printf(byval stream as GOutputStream ptr, byval bytes_written as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr, byval format as const gchar ptr, ...) as gboolean
declare function g_output_stream_vprintf(byval stream as GOutputStream ptr, byval bytes_written as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr, byval format as const gchar ptr, byval args as va_list) as gboolean
declare function g_output_stream_write_bytes(byval stream as GOutputStream ptr, byval bytes as GBytes ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_output_stream_splice(byval stream as GOutputStream ptr, byval source as GInputStream ptr, byval flags as GOutputStreamSpliceFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_output_stream_flush(byval stream as GOutputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_output_stream_close(byval stream as GOutputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_output_stream_write_async(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_output_stream_write_all_async(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_output_stream_write_bytes_async(byval stream as GOutputStream ptr, byval bytes as GBytes ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_output_stream_splice_async(byval stream as GOutputStream ptr, byval source as GInputStream ptr, byval flags as GOutputStreamSpliceFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_output_stream_flush_async(byval stream as GOutputStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_output_stream_close_async(byval stream as GOutputStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
#define __G_CuredLABLE_H__
#define G_TYPE_CuredLABLE g_Curedlable_get_type()
#define G_CuredLABLE(o) G_TYPE_CHECK_INSTANCE_CAST((o), G_TYPE_CuredLABLE, GCuredlable)
#define G_CuredLABLE_CLASS(k) G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_CuredLABLE, GCuredlableClass)
#define G_IS_CuredLABLE(o) G_TYPE_CHECK_INSTANCE_TYPE((o), G_TYPE_CuredLABLE)
#define G_IS_CuredLABLE_CLASS(k) G_TYPE_CHECK_CLASS_TYPE((k), G_TYPE_CuredLABLE)
#define G_CuredLABLE_GET_CLASS(o) G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_CuredLABLE, GCuredlableClass)
type GCuredlableClass as _GCuredlableClass
type GCuredlablePrivate as _GCuredlablePrivate

type _GCuredlable
	parent_instance as GObject
	priv as GCuredlablePrivate ptr
end type

type _GCuredlableClass
	parent_class as GObjectClass
	Curedled as sub(byval Curedlable as GCuredlable ptr)
	_g_reserved1 as sub()
	_g_reserved2 as sub()
	_g_reserved3 as sub()
	_g_reserved4 as sub()
...
declare function g_Curedlable_get_type() as GType
declare function g_Curedlable_new() as GCuredlable ptr
declare function g_Curedlable_is_Curedled(byval Curedlable as GCuredlable ptr) as gboolean
declare function g_Curedlable_set_error_if_Curedled(byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_Curedlable_get_fd(byval Curedlable as GCuredlable ptr) as long
declare function g_Curedlable_make_pollfd(byval Curedlable as GCuredlable ptr, byval pollfd as GPollFD ptr) as gboolean
declare sub g_Curedlable_release_fd(byval Curedlable as GCuredlable ptr)
declare function g_Curedlable_source_new(byval Curedlable as GCuredlable ptr) as GSource ptr
declare function g_Curedlable_get_current() as GCuredlable ptr
declare sub g_Curedlable_push_current(byval Curedlable as GCuredlable ptr)
declare sub g_Curedlable_pop_current(byval Curedlable as GCuredlable ptr)
declare sub g_Curedlable_reset(byval Curedlable as GCuredlable ptr)
declare function g_Curedlable_connect(byval Curedlable as GCuredlable ptr, byval callback as GCallback, byval data as gpointer, byval data_destroy_func as GDestroyNotify) as gulong
declare sub g_Curedlable_disconnect(byval Curedlable as GCuredlable ptr, byval handler_id as gulong)
declare sub g_Curedlable_Cured(byval Curedlable as GCuredlable ptr)
...
declare function g_data_input_stream_read_byte(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as guchar
declare function g_data_input_stream_read_int16(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gint16
declare function g_data_input_stream_read_uint16(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as guint16
declare function g_data_input_stream_read_int32(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gint32
declare function g_data_input_stream_read_uint32(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as guint32
declare function g_data_input_stream_read_int64(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gint64
declare function g_data_input_stream_read_uint64(byval stream as GDataInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as guint64
declare function g_data_input_stream_read_line(byval stream as GDataInputStream ptr, byval length as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as zstring ptr
declare function g_data_input_stream_read_line_utf8(byval stream as GDataInputStream ptr, byval length as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as zstring ptr
declare sub g_data_input_stream_read_line_async(byval stream as GDataInputStream ptr, byval io_priority as gint, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_data_input_stream_read_until(byval stream as GDataInputStream ptr, byval stop_chars as const gchar ptr, byval length as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as zstring ptr
declare sub g_data_input_stream_read_until_async(byval stream as GDataInputStream ptr, byval stop_chars as const gchar ptr, byval io_priority as gint, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_data_input_stream_read_upto(byval stream as GDataInputStream ptr, byval stop_chars as const gchar ptr, byval stop_chars_len as gssize, byval length as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as zstring ptr
declare sub g_data_input_stream_read_upto_async(byval stream as GDataInputStream ptr, byval stop_chars as const gchar ptr, byval stop_chars_len as gssize, byval io_priority as gint, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_data_output_stream_put_byte(byval stream as GDataOutputStream ptr, byval data as guchar, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_int16(byval stream as GDataOutputStream ptr, byval data as gint16, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_uint16(byval stream as GDataOutputStream ptr, byval data as guint16, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_int32(byval stream as GDataOutputStream ptr, byval data as gint32, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_uint32(byval stream as GDataOutputStream ptr, byval data as guint32, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_int64(byval stream as GDataOutputStream ptr, byval data as gint64, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_uint64(byval stream as GDataOutputStream ptr, byval data as guint64, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_data_output_stream_put_string(byval stream as GDataOutputStream ptr, byval str as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
declare sub g_dbus_address_get_stream(byval address as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_address_get_stream_sync(byval address as const gchar ptr, byval out_guid as gchar ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GIOStream ptr
declare function g_dbus_address_get_for_bus_sync(byval bus_type as GBusType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr
...
declare sub g_bus_get(byval bus_type as GBusType, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
declare function g_bus_get_finish(byval res as GAsyncResult ptr, byval error as GError ptr ptr) as GDBusConnection ptr
declare function g_bus_get_sync(byval bus_type as GBusType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GDBusConnection ptr
declare sub g_dbus_connection_new(byval stream as GIOStream ptr, byval guid as const gchar ptr, byval flags as GDBusConnectionFlags, byval observer as GDBusAuthObserver ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_connection_new_sync(byval stream as GIOStream ptr, byval guid as const gchar ptr, byval flags as GDBusConnectionFlags, byval observer as GDBusAuthObserver ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GDBusConnection ptr
declare sub g_dbus_connection_new_for_address(byval address as const gchar ptr, byval flags as GDBusConnectionFlags, byval observer as GDBusAuthObserver ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_connection_new_for_address_sync(byval address as const gchar ptr, byval flags as GDBusConnectionFlags, byval observer as GDBusAuthObserver ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GDBusConnection ptr
...
declare sub g_dbus_connection_close(byval connection as GDBusConnection ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_connection_close_sync(byval connection as GDBusConnection ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_dbus_connection_flush(byval connection as GDBusConnection ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_connection_flush_sync(byval connection as GDBusConnection ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
declare function g_dbus_connection_send_message_with_reply_sync(byval connection as GDBusConnection ptr, byval message as GDBusMessage ptr, byval flags as GDBusSendMessageFlags, byval timeout_msec as gint, byval out_serial as guint32 ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GDBusMessage ptr
...
declare sub g_dbus_connection_call(byval connection as GDBusConnection ptr, byval bus_name as const gchar ptr, byval object_path as const gchar ptr, byval interface_name as const gchar ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval reply_type as const GVariantType ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_connection_call_sync(byval connection as GDBusConnection ptr, byval bus_name as const gchar ptr, byval object_path as const gchar ptr, byval interface_name as const gchar ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval reply_type as const GVariantType ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GVariant ptr
declare sub g_dbus_connection_call_with_unix_fd_list(byval connection as GDBusConnection ptr, byval bus_name as const gchar ptr, byval object_path as const gchar ptr, byval interface_name as const gchar ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval reply_type as const GVariantType ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval fd_list as GUnixFDList ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_connection_call_with_unix_fd_list_sync(byval connection as GDBusConnection ptr, byval bus_name as const gchar ptr, byval object_path as const gchar ptr, byval interface_name as const gchar ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval reply_type as const GVariantType ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval fd_list as GUnixFDList ptr, byval out_fd_list as GUnixFDList ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GVariant ptr
...
declare sub g_dbus_proxy_call(byval proxy as GDBusProxy ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_proxy_call_sync(byval proxy as GDBusProxy ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GVariant ptr
declare sub g_dbus_proxy_call_with_unix_fd_list(byval proxy as GDBusProxy ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval fd_list as GUnixFDList ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_proxy_call_with_unix_fd_list_sync(byval proxy as GDBusProxy ptr, byval method_name as const gchar ptr, byval parameters as GVariant ptr, byval flags as GDBusCallFlags, byval timeout_msec as gint, byval fd_list as GUnixFDList ptr, byval out_fd_list as GUnixFDList ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GVariant ptr
...
declare function g_dbus_server_new_sync(byval address as const gchar ptr, byval flags as GDBusServerFlags, byval guid as const gchar ptr, byval observer as GDBusAuthObserver ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GDBusServer ptr
...
type _GDriveIface
	...
	eject as sub(byval drive as GDrive ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	poll_for_media as sub(byval drive as GDrive ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	start as sub(byval drive as GDrive ptr, byval flags as GDriveStartFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	stop as sub(byval drive as GDrive ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject_with_operation as sub(byval drive as GDrive ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_drive_eject(byval drive as GDrive ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_drive_poll_for_media(byval drive as GDrive ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_drive_start(byval drive as GDrive ptr, byval flags as GDriveStartFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_drive_stop(byval drive as GDrive ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_drive_eject_with_operation(byval drive as GDrive ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GFileEnumeratorClass
	parent_class as GObjectClass
	next_file as function(byval enumerator as GFileEnumerator ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
	close_fn as function(byval enumerator as GFileEnumerator ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	next_files_async as sub(byval enumerator as GFileEnumerator ptr, byval num_files as long, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	close_async as sub(byval enumerator as GFileEnumerator ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_enumerator_next_file(byval enumerator as GFileEnumerator ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
declare function g_file_enumerator_close(byval enumerator as GFileEnumerator ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_enumerator_next_files_async(byval enumerator as GFileEnumerator ptr, byval num_files as long, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_enumerator_close_async(byval enumerator as GFileEnumerator ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_enumerator_iterate(byval direnum as GFileEnumerator ptr, byval out_info as GFileInfo ptr ptr, byval out_child as GFile ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
type _GFileIface
	...
	enumerate_children as function(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileEnumerator ptr
	enumerate_children_async as sub(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	query_info as function(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
	query_info_async as sub(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	query_filesystem_info as function(byval file as GFile ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
	query_filesystem_info_async as sub(byval file as GFile ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	find_enclosing_mount as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GMount ptr
	find_enclosing_mount_async as sub(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	set_display_name as function(byval file as GFile ptr, byval display_name as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFile ptr
	set_display_name_async as sub(byval file as GFile ptr, byval display_name as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	query_settable_attributes as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileAttributeInfoList ptr
	_query_settable_attributes_async as sub()
	_query_settable_attributes_finish as sub()
	query_writable_namespaces as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileAttributeInfoList ptr
	_query_writable_namespaces_async as sub()
	_query_writable_namespaces_finish as sub()
	set_attribute as function(byval file as GFile ptr, byval attribute as const zstring ptr, byval type as GFileAttributeType, byval value_p as gpointer, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	set_attributes_from_info as function(byval file as GFile ptr, byval info as GFileInfo ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	set_attributes_async as sub(byval file as GFile ptr, byval info as GFileInfo ptr, byval flags as GFileQueryInfoFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	read_fn as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInputStream ptr
	read_async as sub(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	append_to as function(byval file as GFile ptr, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileOutputStream ptr
	append_to_async as sub(byval file as GFile ptr, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	create as function(byval file as GFile ptr, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileOutputStream ptr
	create_async as sub(byval file as GFile ptr, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	replace as function(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileOutputStream ptr
	replace_async as sub(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	delete_file as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	delete_file_async as sub(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	trash as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	trash_async as sub(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	make_directory as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	make_directory_async as sub(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	make_symbolic_link as function(byval file as GFile ptr, byval symlink_value as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	_make_symbolic_link_async as sub()
	_make_symbolic_link_finish as sub()
	copy as function(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileProgressCallback, byval progress_callback_data as gpointer, byval error as GError ptr ptr) as gboolean
	copy_async as sub(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileProgressCallback, byval progress_callback_data as gpointer, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	copy_finish as function(byval file as GFile ptr, byval res as GAsyncResult ptr, byval error as GError ptr ptr) as gboolean
	move as function(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileProgressCallback, byval progress_callback_data as gpointer, byval error as GError ptr ptr) as gboolean
	_move_async as sub()
	_move_finish as sub()
	mount_mountable as sub(byval file as GFile ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	unmount_mountable as sub(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject_mountable as sub(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	mount_enclosing_volume as sub(byval location as GFile ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	monitor_dir as function(byval file as GFile ptr, byval flags as GFileMonitorFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileMonitor ptr
	monitor_file as function(byval file as GFile ptr, byval flags as GFileMonitorFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileMonitor ptr
	open_readwrite as function(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileIOStream ptr
	open_readwrite_async as sub(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	create_readwrite as function(byval file as GFile ptr, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileIOStream ptr
	create_readwrite_async as sub(byval file as GFile ptr, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	replace_readwrite as function(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileIOStream ptr
	replace_readwrite_async as sub(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	start_mountable as sub(byval file as GFile ptr, byval flags as GDriveStartFlags, byval start_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	stop_mountable as sub(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	unmount_mountable_with_operation as sub(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject_mountable_with_operation as sub(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	poll_mountable as sub(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	measure_disk_usage as function(byval file as GFile ptr, byval flags as GFileMeasureFlags, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileMeasureProgressCallback, byval progress_data as gpointer, byval disk_usage as guint64 ptr, byval num_dirs as guint64 ptr, byval num_files as guint64 ptr, byval error as GError ptr ptr) as gboolean
	measure_disk_usage_async as sub(byval file as GFile ptr, byval flags as GFileMeasureFlags, byval io_priority as gint, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileMeasureProgressCallback, byval progress_data as gpointer, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_read(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInputStream ptr
declare sub g_file_read_async(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_append_to(byval file as GFile ptr, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileOutputStream ptr
declare function g_file_create(byval file as GFile ptr, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileOutputStream ptr
declare function g_file_replace(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileOutputStream ptr
declare sub g_file_append_to_async(byval file as GFile ptr, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_create_async(byval file as GFile ptr, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_replace_async(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_open_readwrite(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileIOStream ptr
declare sub g_file_open_readwrite_async(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_create_readwrite(byval file as GFile ptr, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileIOStream ptr
declare sub g_file_create_readwrite_async(byval file as GFile ptr, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_replace_readwrite(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileIOStream ptr
declare sub g_file_replace_readwrite_async(byval file as GFile ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_query_exists(byval file as GFile ptr, byval Curedlable as GCuredlable ptr) as gboolean
declare function g_file_query_file_type(byval file as GFile ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr) as GFileType
declare function g_file_query_info(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
declare sub g_file_query_info_async(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_query_filesystem_info(byval file as GFile ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
declare sub g_file_query_filesystem_info_async(byval file as GFile ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_find_enclosing_mount(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GMount ptr
declare sub g_file_find_enclosing_mount_async(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_enumerate_children(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileEnumerator ptr
declare sub g_file_enumerate_children_async(byval file as GFile ptr, byval attributes as const zstring ptr, byval flags as GFileQueryInfoFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_set_display_name(byval file as GFile ptr, byval display_name as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFile ptr
declare sub g_file_set_display_name_async(byval file as GFile ptr, byval display_name as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_delete(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_delete_async(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_trash(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_trash_async(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_copy(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileProgressCallback, byval progress_callback_data as gpointer, byval error as GError ptr ptr) as gboolean
declare sub g_file_copy_async(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileProgressCallback, byval progress_callback_data as gpointer, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_move(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval Curedlable as GCuredlable ptr, byval progress_callback as GFileProgressCallback, byval progress_callback_data as gpointer, byval error as GError ptr ptr) as gboolean
declare function g_file_make_directory(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_make_directory_async(byval file as GFile ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_make_directory_with_parents(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_make_symbolic_link(byval file as GFile ptr, byval symlink_value as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_query_settable_attributes(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileAttributeInfoList ptr
declare function g_file_query_writable_namespaces(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileAttributeInfoList ptr
declare function g_file_set_attribute(byval file as GFile ptr, byval attribute as const zstring ptr, byval type as GFileAttributeType, byval value_p as gpointer, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_set_attributes_from_info(byval file as GFile ptr, byval info as GFileInfo ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_set_attributes_async(byval file as GFile ptr, byval info as GFileInfo ptr, byval flags as GFileQueryInfoFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_set_attribute_string(byval file as GFile ptr, byval attribute as const zstring ptr, byval value as const zstring ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_set_attribute_byte_string(byval file as GFile ptr, byval attribute as const zstring ptr, byval value as const zstring ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_set_attribute_uint32(byval file as GFile ptr, byval attribute as const zstring ptr, byval value as guint32, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_set_attribute_int32(byval file as GFile ptr, byval attribute as const zstring ptr, byval value as gint32, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_set_attribute_uint64(byval file as GFile ptr, byval attribute as const zstring ptr, byval value as guint64, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_set_attribute_int64(byval file as GFile ptr, byval attribute as const zstring ptr, byval value as gint64, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_mount_enclosing_volume(byval location as GFile ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_mount_mountable(byval file as GFile ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_unmount_mountable(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_unmount_mountable_with_operation(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_eject_mountable(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_eject_mountable_with_operation(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_copy_attributes(byval source as GFile ptr, byval destination as GFile ptr, byval flags as GFileCopyFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_file_monitor_directory(byval file as GFile ptr, byval flags as GFileMonitorFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileMonitor ptr
declare function g_file_monitor_file(byval file as GFile ptr, byval flags as GFileMonitorFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileMonitor ptr
declare function g_file_monitor_ alias "g_file_monitor"(byval file as GFile ptr, byval flags as GFileMonitorFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileMonitor ptr
...
declare sub g_file_start_mountable(byval file as GFile ptr, byval flags as GDriveStartFlags, byval start_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_stop_mountable(byval file as GFile ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_poll_mountable(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_query_default_handler(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GAppInfo ptr
declare function g_file_load_contents(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval contents as zstring ptr ptr, byval length as gsize ptr, byval etag_out as zstring ptr ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_load_contents_async(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_file_load_partial_contents_async(byval file as GFile ptr, byval Curedlable as GCuredlable ptr, byval read_more_callback as GFileReadMoreCallback, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_replace_contents(byval file as GFile ptr, byval contents as const zstring ptr, byval length as gsize, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval new_etag as zstring ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_file_replace_contents_async(byval file as GFile ptr, byval contents as const zstring ptr, byval length as gsize, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
declare sub g_file_replace_contents_bytes_async(byval file as GFile ptr, byval contents as GBytes ptr, byval etag as const zstring ptr, byval make_backup as gboolean, byval flags as GFileCreateFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GFileInputStreamClass
	...
	seek as function(byval stream as GFileInputStream ptr, byval offset as goffset, byval type as GSeekType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	query_info as function(byval stream as GFileInputStream ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
	query_info_async as sub(byval stream as GFileInputStream ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_input_stream_query_info(byval stream as GFileInputStream ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
declare sub g_file_input_stream_query_info_async(byval stream as GFileInputStream ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GIOStreamClass
	...
	close_fn as function(byval stream as GIOStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	close_async as sub(byval stream as GIOStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_io_stream_splice_async(byval stream1 as GIOStream ptr, byval stream2 as GIOStream ptr, byval flags as GIOStreamSpliceFlags, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
declare function g_io_stream_splice_finish(byval result as GAsyncResult ptr, byval error as GError ptr ptr) as gboolean
declare function g_io_stream_close(byval stream as GIOStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_io_stream_close_async(byval stream as GIOStream ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GFileIOStreamClass
	...
	seek as function(byval stream as GFileIOStream ptr, byval offset as goffset, byval type as GSeekType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	can_truncate as function(byval stream as GFileIOStream ptr) as gboolean
	truncate_fn as function(byval stream as GFileIOStream ptr, byval size as goffset, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	query_info as function(byval stream as GFileIOStream ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
	query_info_async as sub(byval stream as GFileIOStream ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_io_stream_query_info(byval stream as GFileIOStream ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
declare sub g_file_io_stream_query_info_async(byval stream as GFileIOStream ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GFileMonitorClass
	...
	Cured as function(byval monitor as GFileMonitor ptr) as gboolean
	_g_reserved1 as sub()
	_g_reserved2 as sub()
	_g_reserved3 as sub()
	_g_reserved4 as sub()
...
declare function g_file_monitor_Cured(byval monitor as GFileMonitor ptr) as gboolean
declare function g_file_monitor_is_Curedled(byval monitor as GFileMonitor ptr) as gboolean
...
type _GFileOutputStreamClass
	...
	seek as function(byval stream as GFileOutputStream ptr, byval offset as goffset, byval type as GSeekType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	can_truncate as function(byval stream as GFileOutputStream ptr) as gboolean
	truncate_fn as function(byval stream as GFileOutputStream ptr, byval size as goffset, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	query_info as function(byval stream as GFileOutputStream ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
	query_info_async as sub(byval stream as GFileOutputStream ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_file_output_stream_query_info(byval stream as GFileOutputStream ptr, byval attributes as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GFileInfo ptr
declare sub g_file_output_stream_query_info_async(byval stream as GFileOutputStream ptr, byval attributes as const zstring ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_io_scheduler_push_job(byval job_func as GIOSchedulerJobFunc, byval user_data as gpointer, byval notify as GDestroyNotify, byval io_priority as gint, byval Curedlable as GCuredlable ptr)
declare sub g_io_scheduler_Cured_all_jobs()
...
type _GLoadableIconIface
	g_iface as GTypeInterface
	load as function(byval icon as GLoadableIcon ptr, byval size as long, byval type as zstring ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GInputStream ptr
	load_async as sub(byval icon as GLoadableIcon ptr, byval size as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_loadable_icon_load(byval icon as GLoadableIcon ptr, byval size as long, byval type as zstring ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GInputStream ptr
declare sub g_loadable_icon_load_async(byval icon as GLoadableIcon ptr, byval size as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GMountIface
	...
	unmount as sub(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject as sub(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	remount as sub(byval mount as GMount ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	guess_content_type as sub(byval mount as GMount ptr, byval force_rescan as gboolean, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	guess_content_type_sync as function(byval mount as GMount ptr, byval force_rescan as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr ptr
	pre_unmount as sub(byval mount as GMount ptr)
	unmount_with_operation as sub(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject_with_operation as sub(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_mount_unmount(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_mount_eject(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_mount_remount(byval mount as GMount ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_mount_guess_content_type(byval mount as GMount ptr, byval force_rescan as gboolean, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_mount_guess_content_type_sync(byval mount as GMount ptr, byval force_rescan as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr ptr
...
declare sub g_mount_unmount_with_operation(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_mount_eject_with_operation(byval mount as GMount ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GNativeVolumeMonitorClass
	...
	get_mount_for_mount_path as function(byval mount_path as const zstring ptr, byval Curedlable as GCuredlable ptr) as GMount ptr
end type
...
type _GNetworkMonitorInterface
	...
	can_reach as function(byval monitor as GNetworkMonitor ptr, byval connectable as GSocketConnectable ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	can_reach_async as sub(byval monitor as GNetworkMonitor ptr, byval connectable as GSocketConnectable ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_network_monitor_can_reach(byval monitor as GNetworkMonitor ptr, byval connectable as GSocketConnectable ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_network_monitor_can_reach_async(byval monitor as GNetworkMonitor ptr, byval connectable as GSocketConnectable ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GPermissionClass
	parent_class as GObjectClass
	acquire as function(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	acquire_async as sub(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	release as function(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	release_async as sub(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_permission_acquire(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_permission_acquire_async(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_permission_release(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_permission_release_async(byval permission as GPermission ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GPollableInputStreamInterface
	...
	create_source as function(byval stream as GPollableInputStream ptr, byval Curedlable as GCuredlable ptr) as GSource ptr
...
declare function g_pollable_input_stream_create_source(byval stream as GPollableInputStream ptr, byval Curedlable as GCuredlable ptr) as GSource ptr
declare function g_pollable_input_stream_read_nonblocking(byval stream as GPollableInputStream ptr, byval buffer as any ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
...
type _GPollableOutputStreamInterface
	...
	create_source as function(byval stream as GPollableOutputStream ptr, byval Curedlable as GCuredlable ptr) as GSource ptr
...
declare function g_pollable_output_stream_create_source(byval stream as GPollableOutputStream ptr, byval Curedlable as GCuredlable ptr) as GSource ptr
declare function g_pollable_output_stream_write_nonblocking(byval stream as GPollableOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
#define __G_POLLABLE_UTILS_H__
declare function g_pollable_source_new(byval pollable_stream as GObject ptr) as GSource ptr
declare function g_pollable_source_new_full(byval pollable_stream as gpointer, byval child_source as GSource ptr, byval Curedlable as GCuredlable ptr) as GSource ptr
declare function g_pollable_stream_read(byval stream as GInputStream ptr, byval buffer as any ptr, byval count as gsize, byval blocking as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_pollable_stream_write(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval blocking as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_pollable_stream_write_all(byval stream as GOutputStream ptr, byval buffer as const any ptr, byval count as gsize, byval blocking as gboolean, byval bytes_written as gsize ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
type _GProxyInterface
	g_iface as GTypeInterface
	connect as function(byval proxy as GProxy ptr, byval connection as GIOStream ptr, byval proxy_address as GProxyAddress ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GIOStream ptr
	connect_async as sub(byval proxy as GProxy ptr, byval connection as GIOStream ptr, byval proxy_address as GProxyAddress ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_proxy_connect(byval proxy as GProxy ptr, byval connection as GIOStream ptr, byval proxy_address as GProxyAddress ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GIOStream ptr
declare sub g_proxy_connect_async(byval proxy as GProxy ptr, byval connection as GIOStream ptr, byval proxy_address as GProxyAddress ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GSocketAddressEnumeratorClass
	parent_class as GObjectClass
	next as function(byval enumerator as GSocketAddressEnumerator ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketAddress ptr
	next_async as sub(byval enumerator as GSocketAddressEnumerator ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_socket_address_enumerator_next(byval enumerator as GSocketAddressEnumerator ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketAddress ptr
declare sub g_socket_address_enumerator_next_async(byval enumerator as GSocketAddressEnumerator ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GProxyResolverInterface
	...
	lookup as function(byval resolver as GProxyResolver ptr, byval uri as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr ptr
	lookup_async as sub(byval resolver as GProxyResolver ptr, byval uri as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_proxy_resolver_lookup(byval resolver as GProxyResolver ptr, byval uri as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr ptr
declare sub g_proxy_resolver_lookup_async(byval resolver as GProxyResolver ptr, byval uri as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GResolverClass
	...
	lookup_by_name as function(byval resolver as GResolver ptr, byval hostname as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
	lookup_by_name_async as sub(byval resolver as GResolver ptr, byval hostname as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	lookup_by_address as function(byval resolver as GResolver ptr, byval address as GInetAddress ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr
	lookup_by_address_async as sub(byval resolver as GResolver ptr, byval address as GInetAddress ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	lookup_service as function(byval resolver as GResolver ptr, byval rrname as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
	lookup_service_async as sub(byval resolver as GResolver ptr, byval rrname as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	lookup_records as function(byval resolver as GResolver ptr, byval rrname as const gchar ptr, byval record_type as GResolverRecordType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
	lookup_records_async as sub(byval resolver as GResolver ptr, byval rrname as const gchar ptr, byval record_type as GResolverRecordType, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_resolver_lookup_by_name(byval resolver as GResolver ptr, byval hostname as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
declare sub g_resolver_lookup_by_name_async(byval resolver as GResolver ptr, byval hostname as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_resolver_lookup_by_address(byval resolver as GResolver ptr, byval address as GInetAddress ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gchar ptr
declare sub g_resolver_lookup_by_address_async(byval resolver as GResolver ptr, byval address as GInetAddress ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_resolver_lookup_service(byval resolver as GResolver ptr, byval service as const gchar ptr, byval protocol as const gchar ptr, byval domain as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
declare sub g_resolver_lookup_service_async(byval resolver as GResolver ptr, byval service as const gchar ptr, byval protocol as const gchar ptr, byval domain as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_resolver_lookup_records(byval resolver as GResolver ptr, byval rrname as const gchar ptr, byval record_type as GResolverRecordType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
declare sub g_resolver_lookup_records_async(byval resolver as GResolver ptr, byval rrname as const gchar ptr, byval record_type as GResolverRecordType, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GSeekableIface
	...
	seek as function(byval seekable as GSeekable ptr, byval offset as goffset, byval type as GSeekType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	can_truncate as function(byval seekable as GSeekable ptr) as gboolean
	truncate_fn as function(byval seekable as GSeekable ptr, byval offset as goffset, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
end type
...
declare function g_seekable_seek(byval seekable as GSeekable ptr, byval offset as goffset, byval type as GSeekType, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_seekable_can_truncate(byval seekable as GSeekable ptr) as gboolean
declare function g_seekable_truncate(byval seekable as GSeekable ptr, byval offset as goffset, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
declare sub g_simple_async_result_set_check_Curedlable(byval simple as GSimpleAsyncResult ptr, byval check_Curedlable as GCuredlable ptr)
declare function g_simple_async_result_get_source_tag(byval simple as GSimpleAsyncResult ptr) as gpointer
declare sub g_simple_async_result_set_handle_Curedlation(byval simple as GSimpleAsyncResult ptr, byval handle_Curedlation as gboolean)
...
declare sub g_simple_async_result_run_in_thread(byval simple as GSimpleAsyncResult ptr, byval func as GSimpleAsyncThreadFunc, byval io_priority as long, byval Curedlable as GCuredlable ptr)
...
declare function g_socket_client_connect(byval client as GSocketClient ptr, byval connectable as GSocketConnectable ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketConnection ptr
declare function g_socket_client_connect_to_host(byval client as GSocketClient ptr, byval host_and_port as const gchar ptr, byval default_port as guint16, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketConnection ptr
declare function g_socket_client_connect_to_service(byval client as GSocketClient ptr, byval domain as const gchar ptr, byval service as const gchar ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketConnection ptr
declare function g_socket_client_connect_to_uri(byval client as GSocketClient ptr, byval uri as const gchar ptr, byval default_port as guint16, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketConnection ptr
declare sub g_socket_client_connect_async(byval client as GSocketClient ptr, byval connectable as GSocketConnectable ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_socket_client_connect_to_host_async(byval client as GSocketClient ptr, byval host_and_port as const gchar ptr, byval default_port as guint16, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_socket_client_connect_to_service_async(byval client as GSocketClient ptr, byval domain as const gchar ptr, byval service as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_socket_client_connect_to_uri_async(byval client as GSocketClient ptr, byval uri as const gchar ptr, byval default_port as guint16, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_socket_connect(byval socket as GSocket ptr, byval address as GSocketAddress ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
declare function g_socket_condition_wait(byval socket as GSocket ptr, byval condition as GIOCondition, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_socket_condition_timed_wait(byval socket as GSocket ptr, byval condition as GIOCondition, byval timeout as gint64, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare function g_socket_accept(byval socket as GSocket ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocket ptr
declare function g_socket_listen(byval socket as GSocket ptr, byval error as GError ptr ptr) as gboolean
declare function g_socket_receive(byval socket as GSocket ptr, byval buffer as gchar ptr, byval size as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_receive_from(byval socket as GSocket ptr, byval address as GSocketAddress ptr ptr, byval buffer as gchar ptr, byval size as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_send(byval socket as GSocket ptr, byval buffer as const gchar ptr, byval size as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_send_to(byval socket as GSocket ptr, byval address as GSocketAddress ptr, byval buffer as const gchar ptr, byval size as gsize, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_receive_message(byval socket as GSocket ptr, byval address as GSocketAddress ptr ptr, byval vectors as GInputVector ptr, byval num_vectors as gint, byval messages as GSocketControlMessage ptr ptr ptr, byval num_messages as gint ptr, byval flags as gint ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_send_message(byval socket as GSocket ptr, byval address as GSocketAddress ptr, byval vectors as GOutputVector ptr, byval num_vectors as gint, byval messages as GSocketControlMessage ptr ptr, byval num_messages as gint, byval flags as gint, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_send_messages(byval socket as GSocket ptr, byval messages as GOutputMessage ptr, byval num_messages as guint, byval flags as gint, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gint
...
declare function g_socket_create_source(byval socket as GSocket ptr, byval condition as GIOCondition, byval Curedlable as GCuredlable ptr) as GSource ptr
...
declare function g_socket_receive_with_blocking(byval socket as GSocket ptr, byval buffer as gchar ptr, byval size as gsize, byval blocking as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
declare function g_socket_send_with_blocking(byval socket as GSocket ptr, byval buffer as const gchar ptr, byval size as gsize, byval blocking as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gssize
...
declare function g_socket_connection_connect(byval connection as GSocketConnection ptr, byval address as GSocketAddress ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_socket_connection_connect_async(byval connection as GSocketConnection ptr, byval address as GSocketAddress ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_socket_listener_accept_socket(byval listener as GSocketListener ptr, byval source_object as GObject ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocket ptr
declare sub g_socket_listener_accept_socket_async(byval listener as GSocketListener ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_socket_listener_accept(byval listener as GSocketListener ptr, byval source_object as GObject ptr ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GSocketConnection ptr
declare sub g_socket_listener_accept_async(byval listener as GSocketListener ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_task_new(byval source_object as gpointer, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval callback_data as gpointer) as GTask ptr
...
declare sub g_task_set_check_Curedlable(byval task as GTask ptr, byval check_Curedlable as gboolean)
...
declare function g_task_get_Curedlable(byval task as GTask ptr) as GCuredlable ptr
declare function g_task_get_check_Curedlable(byval task as GTask ptr) as gboolean
...
type GTaskThreadFunc as sub(byval task as GTask ptr, byval source_object as gpointer, byval task_data as gpointer, byval Curedlable as GCuredlable ptr)
...
declare function g_task_set_return_on_Cured(byval task as GTask ptr, byval return_on_Cured as gboolean) as gboolean
declare function g_task_get_return_on_Cured(byval task as GTask ptr) as gboolean
...
declare function g_task_return_error_if_Curedled(byval task as GTask ptr) as gboolean
...
declare function g_subprocess_wait(byval subprocess as GSubprocess ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_subprocess_wait_async(byval subprocess as GSubprocess ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_subprocess_wait_check(byval subprocess as GSubprocess ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_subprocess_wait_check_async(byval subprocess as GSubprocess ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_subprocess_communicate(byval subprocess as GSubprocess ptr, byval stdin_buf as GBytes ptr, byval Curedlable as GCuredlable ptr, byval stdout_buf as GBytes ptr ptr, byval stderr_buf as GBytes ptr ptr, byval error as GError ptr ptr) as gboolean
declare sub g_subprocess_communicate_async(byval subprocess as GSubprocess ptr, byval stdin_buf as GBytes ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_subprocess_communicate_utf8(byval subprocess as GSubprocess ptr, byval stdin_buf as const zstring ptr, byval Curedlable as GCuredlable ptr, byval stdout_buf as zstring ptr ptr, byval stderr_buf as zstring ptr ptr, byval error as GError ptr ptr) as gboolean
declare sub g_subprocess_communicate_utf8_async(byval subprocess as GSubprocess ptr, byval stdin_buf as const zstring ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GTlsConnectionClass
	...
	handshake as function(byval conn as GTlsConnection ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
	handshake_async as sub(byval conn as GTlsConnection ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_tls_connection_handshake(byval conn as GTlsConnection ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
declare sub g_tls_connection_handshake_async(byval conn as GTlsConnection ptr, byval io_priority as long, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GTlsDatabaseClass
	parent_class as GObjectClass
	verify_chain as function(byval self as GTlsDatabase ptr, byval chain as GTlsCertificate ptr, byval purpose as const gchar ptr, byval identity as GSocketConnectable ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseVerifyFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsCertificateFlags
	verify_chain_async as sub(byval self as GTlsDatabase ptr, byval chain as GTlsCertificate ptr, byval purpose as const gchar ptr, byval identity as GSocketConnectable ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseVerifyFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	lookup_certificate_for_handle as function(byval self as GTlsDatabase ptr, byval handle as const gchar ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsCertificate ptr
	lookup_certificate_for_handle_async as sub(byval self as GTlsDatabase ptr, byval handle as const gchar ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	lookup_certificate_issuer as function(byval self as GTlsDatabase ptr, byval certificate as GTlsCertificate ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsCertificate ptr
	lookup_certificate_issuer_async as sub(byval self as GTlsDatabase ptr, byval certificate as GTlsCertificate ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	lookup_certificates_issued_by as function(byval self as GTlsDatabase ptr, byval issuer_raw_dn as GByteArray ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
	lookup_certificates_issued_by_async as sub(byval self as GTlsDatabase ptr, byval issuer_raw_dn as GByteArray ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_tls_database_lookup_certificate_for_handle(byval self as GTlsDatabase ptr, byval handle as const gchar ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsCertificate ptr
declare sub g_tls_database_lookup_certificate_for_handle_async(byval self as GTlsDatabase ptr, byval handle as const gchar ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_tls_database_lookup_certificate_issuer(byval self as GTlsDatabase ptr, byval certificate as GTlsCertificate ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsCertificate ptr
declare sub g_tls_database_lookup_certificate_issuer_async(byval self as GTlsDatabase ptr, byval certificate as GTlsCertificate ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_tls_database_lookup_certificates_issued_by(byval self as GTlsDatabase ptr, byval issuer_raw_dn as GByteArray ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GList ptr
declare sub g_tls_database_lookup_certificates_issued_by_async(byval self as GTlsDatabase ptr, byval issuer_raw_dn as GByteArray ptr, byval interaction as GTlsInteraction ptr, byval flags as GTlsDatabaseLookupFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GTlsInteractionClass
	parent_class as GObjectClass
	ask_password as function(byval interaction as GTlsInteraction ptr, byval password as GTlsPassword ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsInteractionResult
	ask_password_async as sub(byval interaction as GTlsInteraction ptr, byval password as GTlsPassword ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	request_certificate as function(byval interaction as GTlsInteraction ptr, byval connection as GTlsConnection ptr, byval flags as GTlsCertificateRequestFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsInteractionResult
	request_certificate_async as sub(byval interaction as GTlsInteraction ptr, byval connection as GTlsConnection ptr, byval flags as GTlsCertificateRequestFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_tls_interaction_invoke_ask_password(byval interaction as GTlsInteraction ptr, byval password as GTlsPassword ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsInteractionResult
declare function g_tls_interaction_ask_password(byval interaction as GTlsInteraction ptr, byval password as GTlsPassword ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsInteractionResult
declare sub g_tls_interaction_ask_password_async(byval interaction as GTlsInteraction ptr, byval password as GTlsPassword ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_tls_interaction_invoke_request_certificate(byval interaction as GTlsInteraction ptr, byval connection as GTlsConnection ptr, byval flags as GTlsCertificateRequestFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsInteractionResult
declare function g_tls_interaction_request_certificate(byval interaction as GTlsInteraction ptr, byval connection as GTlsConnection ptr, byval flags as GTlsCertificateRequestFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GTlsInteractionResult
declare sub g_tls_interaction_request_certificate_async(byval interaction as GTlsInteraction ptr, byval connection as GTlsConnection ptr, byval flags as GTlsCertificateRequestFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GVfsClass
	...
	local_file_add_info as sub(byval vfs as GVfs ptr, byval filename as const zstring ptr, byval device as guint64, byval attribute_matcher as GFileAttributeMatcher ptr, byval info as GFileInfo ptr, byval Curedlable as GCuredlable ptr, byval extra_data as gpointer ptr, byval free_extra_data as GDestroyNotify ptr)
	add_writable_namespaces as sub(byval vfs as GVfs ptr, byval list as GFileAttributeInfoList ptr)
	local_file_set_attributes as function(byval vfs as GVfs ptr, byval filename as const zstring ptr, byval info as GFileInfo ptr, byval flags as GFileQueryInfoFlags, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as gboolean
...
type _GVolumeIface
	...
	mount_fn as sub(byval volume as GVolume ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject as sub(byval volume as GVolume ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
	...
	eject_with_operation as sub(byval volume as GVolume ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_volume_mount(byval volume as GVolume ptr, byval flags as GMountMountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_volume_eject(byval volume as GVolume ptr, byval flags as GMountUnmountFlags, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_volume_eject_with_operation(byval volume as GVolume ptr, byval flags as GMountUnmountFlags, byval mount_operation as GMountOperation ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub g_dbus_object_manager_client_new(byval connection as GDBusConnection ptr, byval flags as GDBusObjectManagerClientFlags, byval name as const gchar ptr, byval object_path as const gchar ptr, byval get_proxy_type_func as GDBusProxyTypeFunc, byval get_proxy_type_user_data as gpointer, byval get_proxy_type_destroy_notify as GDestroyNotify, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function g_dbus_object_manager_client_new_sync(byval connection as GDBusConnection ptr, byval flags as GDBusObjectManagerClientFlags, byval name as const gchar ptr, byval object_path as const gchar ptr, byval get_proxy_type_func as GDBusProxyTypeFunc, byval get_proxy_type_user_data as gpointer, byval get_proxy_type_destroy_notify as GDestroyNotify, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GDBusObjectManager ptr
...
type GCuredlable_autoptr as GCuredlable ptr

private sub glib_autoptr_cleanup_GCuredlable(byval _ptr as GCuredlable ptr ptr)
	if *_ptr then
		g_object_unref(*_ptr)
	end if
end sub
