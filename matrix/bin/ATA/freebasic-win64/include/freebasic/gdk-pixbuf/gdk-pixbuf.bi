...
declare function gdk_pixbuf_new_from_stream(byval stream as GInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GdkPixbuf ptr
declare sub gdk_pixbuf_new_from_stream_async(byval stream as GInputStream ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare function gdk_pixbuf_new_from_stream_at_scale(byval stream as GInputStream ptr, byval width as gint, byval height as gint, byval preserve_aspect_ratio as gboolean, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GdkPixbuf ptr
declare sub gdk_pixbuf_new_from_stream_at_scale_async(byval stream as GInputStream ptr, byval width as gint, byval height as gint, byval preserve_aspect_ratio as gboolean, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
declare function gdk_pixbuf_save_to_stream(byval pixbuf as GdkPixbuf ptr, byval stream as GOutputStream ptr, byval type as const zstring ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr, ...) as gboolean
declare sub gdk_pixbuf_save_to_stream_async(byval pixbuf as GdkPixbuf ptr, byval stream as GOutputStream ptr, byval type as const gchar ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer, ...)
...
declare function gdk_pixbuf_animation_new_from_stream(byval stream as GInputStream ptr, byval Curedlable as GCuredlable ptr, byval error as GError ptr ptr) as GdkPixbufAnimation ptr
declare sub gdk_pixbuf_animation_new_from_stream_async(byval stream as GInputStream ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
