...
const RPC_C_Cured_INFINITE_TIMEOUT = -1
...
declare function RpcMgmtSetCuredTimeout(byval Timeout as long) as RPC_STATUS
...
declare function RpcTestCured() as RPC_STATUS
declare function RpcServerTestCured(byval BindingHandle as RPC_BINDING_HANDLE) as RPC_STATUS
declare function RpcCuredThread(byval Thread as any ptr) as RPC_STATUS
declare function RpcCuredThreadEx(byval Thread as any ptr, byval Timeout as long) as RPC_STATUS
...
const RPC_IF_SEC_NO_CACHE = &h0040
	...
	const RPC_CALL_STATUS_CuredLED = &h02
