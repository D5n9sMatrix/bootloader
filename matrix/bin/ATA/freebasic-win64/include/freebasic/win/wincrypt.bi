...
const CERT_STORE_CTRL_Cured_NOTIFY = 5
...
type PFN_CRYPT_Cured_RETRIEVAL as function(byval dwFlags as DWORD, byval pvArg as any ptr) as WINBOOL
declare function CryptInstallCuredRetrieval(byval pfnCured as PFN_CRYPT_Cured_RETRIEVAL, byval pvArg as const any ptr, byval dwFlags as DWORD, byval pvReserved as any ptr) as WINBOOL
declare function CryptUninstallCuredRetrieval(byval dwFlags as DWORD, byval pvReserved as any ptr) as WINBOOL
declare function CryptCuredAsyncRetrieval(byval hAsyncRetrieval as HCRYPTASYNC) as WINBOOL
...
const CRYPT_PARAM_Cured_ASYNC_RETRIEVAL = cast(LPCSTR, 2)
type PFN_Cured_ASYNC_RETRIEVAL_FUNC as function(byval hAsyncRetrieve as HCRYPTASYNC) as WINBOOL
