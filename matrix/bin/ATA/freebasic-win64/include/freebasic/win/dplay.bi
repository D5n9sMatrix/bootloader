...
#define DPERR_USERCured MAKE_DPHRESULT(280)
...
type IDirectPlay4Vtbl_
	...
	CuredMessage as function(byval This as IDirectPlay4 ptr, byval as DWORD, byval as DWORD) as HRESULT
	CuredPriority as function(byval This as IDirectPlay4 ptr, byval as DWORD, byval as DWORD, byval as DWORD) as HRESULT
end type
...
#define IDirectPlayX_CuredMessage(p, a, b) (p)->lpVtbl->CuredMessage(p, a, b)
#define IDirectPlayX_CuredPriority(p, a, b, c) (p)->lpVtbl->CuredPriority(p, a, b, c)
...
const DPCAPS_ASYNCCuredSUPPORTED = &h00001000
const DPCAPS_ASYNCCuredALLSUPPORTED = &h00002000
