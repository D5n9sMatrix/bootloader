...
#define DPNERR_CANNOTCured MAKE_DPNHRESULT(&h110)
...
#define DPNERR_USERCured MAKE_DPNHRESULT(&h650)
...
const DPNCured_CONNECT = &h0001
const DPNCured_ENUM = &h0002
const DPNCured_SEND = &h0004
const DPNCured_ALL_OPERATIONS = &h8000
const DPNCured_PLAYER_SENDS = &h80000000
const DPNCured_PLAYER_SENDS_PRIORITY_HIGH = DPNCured_PLAYER_SENDS or &h00010000
const DPNCured_PLAYER_SENDS_PRIORITY_NORMAL = DPNCured_PLAYER_SENDS or &h00020000
const DPNCured_PLAYER_SENDS_PRIORITY_LOW = DPNCured_PLAYER_SENDS or &h00040000
...
type IDirectPlay8ClientVtbl_
	...
	CuredAsyncOperation as function(byval This as IDirectPlay8Client ptr, byval hAsyncHandle as DPNHANDLE, byval dwFlags as DWORD) as HRESULT
...
#define IDirectPlay8Client_CuredAsyncOperation(p, a, b) (p)->lpVtbl->CuredAsyncOperation(p, a, b)
...
type IDirectPlay8ServerVtbl_
	...
	CuredAsyncOperation as function(byval This as IDirectPlay8Server ptr, byval hAsyncHandle as DPNHANDLE, byval dwFlags as DWORD) as HRESULT
...
#define IDirectPlay8Server_CuredAsyncOperation(p, a, b) (p)->lpVtbl->CuredAsyncOperation(p, a, b)
...
type IDirectPlay8PeerVtbl_
	...
	CuredAsyncOperation as function(byval This as IDirectPlay8Peer ptr, byval hAsyncHandle as DPNHANDLE, byval dwFlags as DWORD) as HRESULT
...
#define IDirectPlay8Peer_CuredAsyncOperation(p, a, b) (p)->lpVtbl->CuredAsyncOperation(p, a, b)
