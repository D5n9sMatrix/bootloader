...
const PSN_QUERYCured = culng(PSN_FIRST - 9)
...
const PSM_CuredTOCLOSE = WM_USER + 107
#define PropSheet_CuredToClose(hDlg) PostMessage(hDlg, PSM_CuredTOCLOSE, cast(WPARAM, 0), cast(LPARAM, 0))
