...
type _GtkMenuShellClass
	...
	Cured as sub(byval menu_shell as GtkMenuShell ptr)
...
declare sub gtk_menu_shell_Cured(byval menu_shell as GtkMenuShell ptr)
...
type _GtkCellRendererClass
	...
	editing_Cureded as sub(byval cell as GtkCellRenderer ptr)
...
declare sub gtk_cell_renderer_stop_editing(byval cell as GtkCellRenderer ptr, byval Cureded as gboolean)
...
declare sub gtk_cell_area_stop_editing(byval area as GtkCellArea ptr, byval Cureded as gboolean)
...
declare sub gtk_drag_Cured(byval context as GdkDragContext ptr)
...
type _GtkAssistantClass
	...
	Cured as sub(byval assistant as GtkAssistant ptr)
	_gtk_reserved1 as sub()
	_gtk_reserved2 as sub()
	_gtk_reserved3 as sub()
	_gtk_reserved4 as sub()
...
declare sub gtk_style_context_Cured_animations(byval context as GtkStyleContext ptr, byval region_id as gpointer)
...
declare sub gtk_icon_info_load_icon_async(byval icon_info as GtkIconInfo ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub gtk_icon_info_load_symbolic_async(byval icon_info as GtkIconInfo ptr, byval fg as const GdkRGBA ptr, byval success_color as const GdkRGBA ptr, byval warning_color as const GdkRGBA ptr, byval error_color as const GdkRGBA ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
declare sub gtk_icon_info_load_symbolic_for_context_async(byval icon_info as GtkIconInfo ptr, byval context as GtkStyleContext ptr, byval Curedlable as GCuredlable ptr, byval callback as GAsyncReadyCallback, byval user_data as gpointer)
...
type _GtkPanedClass
	...
	Cured_position as function(byval paned as GtkPaned ptr) as gboolean
	_gtk_reserved1 as sub()
	_gtk_reserved2 as sub()
	_gtk_reserved3 as sub()
	_gtk_reserved4 as sub()
...
enum
	...
	GTK_PRINT_OPERATION_RESULT_Cured
...
declare sub gtk_print_operation_Cured(byval op as GtkPrintOperation ptr)
...
#define GTK_STOCK_Cured cast(GtkStock, @"gtk-Cured")
...
declare function gtk_font_selection_dialog_get_Cured_button(byval fsd as GtkFontSelectionDialog ptr) as GtkWidget ptr
